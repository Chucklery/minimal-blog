...
世界模型越有解释力，人越容易把它用于所有问题。正见也不例外。它不能替你估算一家公司的现金流，不能替你学习沟通技术，也不能把结构性不公解释成个人执取。一个模型若对每种结果都能事后解释，就失去了被检验的可能。

因此，全书采用三条限制：

- **经验优先**：概念必须回到可观察行为和真实后果；
- **层次清楚**：心理问题、制度问题和道德问题不能彼此偷换；
- **行动检验**：理解若没有改善预测、选择或关系，就仍只是漂亮语言。

想象两位都接受无常的创业者。一个因此拒绝规划，另一个因此保留现金、缩短反馈并准备转向。相同口号产生相反决策，说明真正重要的是推理过程。正见不是用来装饰结论，而是约束结论如何形成。

这也是为什么每章都保留投资、工作和关系的映照。同一个洞见若只能在静坐时成立，进入金钱、权力和亲密之后便消失，它还没有成为稳定理解。
