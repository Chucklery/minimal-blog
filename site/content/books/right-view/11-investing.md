...
上涨不只增加财富，也会重写投资者对自己的解释。连续盈利后，运气被记成能力，风险容忍被误认为风险承受力，环境红利被归入个人方法。随后仓位放大、杠杆增加，系统在最脆弱时让人感觉最安全。

这是正反馈：

```text
上涨 → 信心增加 → 风险暴露增加 → 继续上涨时收益更高 → 信心继续增加
```

回路不会自己标注终点。应对方法不是预测顶部，而是事先设定再平衡、最大仓位和杠杆限制。规则的价值，恰恰在情绪最不愿使用规则时出现。

## 估值是一种反执取训练

喜欢一家公司与愿意支付任何价格是两件事。估值强迫投资者承认：再好的对象，回报也取决于进入条件。关系和职业也有类似“价格”：一份理想工作若要求持续损害健康，成本可能过高；一段有吸引力的关系若反复破坏尊严，不能只计算美好时刻。

当然，人不能被简化成资产。类比只用于提醒：评价对象与评价交易条件必须分开。

## 组合是认识论的表达

仓位不仅表示收益预期，也表示你对自己可能犯错的认识。若声称“任何观点都可能错”，却把全部资本押在一个判断上，行为比语言更诚实地暴露了信念。

分散也不是持有越多越好，而是避免多个仓位依赖同一隐藏条件。十家高增长公司可能共同依赖低利率；多个收入来源可能共同依赖同一平台。真正的分散需要观察因果相关，而不只数名称。
