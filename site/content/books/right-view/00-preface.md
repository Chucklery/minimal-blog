...
假设你错过了一次晋升。第一层反应可能是失望，这是正常损失体验。第二层故事可能迅速扩张：“领导从不认可我”“我的职业已经失败”“同事都在超过我”。若直接相信故事，接下来可能出现退缩、敷衍或冲动离职，它们又会制造新的负面证据。

正见并不要求你假装不难过，而是把事件重新展开：

- 事实：职位给了另一位候选人；
- 未知：决策中能力、名额、关系和时机各占多少；
- 价值：你在乎成长、公平和影响力；
- 可控：询问标准、比较能力差距、观察组织机会；
- 边界：若结构长期不透明，离开也可以是理性选择。

在投资里，同样的过程发生于一次亏损；在关系里，发生于一次拒绝。先让感受存在，再拒绝它垄断因果解释。这样既没有用“接纳”取消行动，也没有用行动逃避感受。

> [!NOTE]
> 平静不是正见的唯一证据。有时看清现实后，你会更明确地愤怒、更果断地退出；区别在于行动不再依赖夸大的故事。
