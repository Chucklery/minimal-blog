...
若把涅槃理解成持续平静，我们又会开始追逐一种不会变化的心理状态。今天冥想安静，就担心明天失去；一旦愤怒出现，便判断练习失败。追求自由反而制造了新的监控与执取。
...
自由因此更像响应能力，而不是情绪天气。天空阴晴变化，驾驶者仍可以根据能见度调整速度。

## 结果目标与方向目标

“必须在三年内升职”是结果目标，它依赖许多外部条件；“持续提升判断、帮助团队交付并诚实沟通”是方向目标，今天就能实践。投资中，年化收益是结果，费用纪律、研究质量和仓位控制是方向。关系中，“永远幸福”是结果，尊重、好奇和修复是方向。

只设方向会缺少衡量，只设结果会产生占有。成熟做法是用结果提供反馈，用方向组织行动：结果未达时调整策略，不必宣布生命失败。

> [!TIP]
> 当一个目标让你越来越僵硬，检查它是否从导航坐标变成了自我存在的许可证。
